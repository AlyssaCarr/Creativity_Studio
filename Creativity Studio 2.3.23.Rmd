...
In each iteration of the evaluation visitor observations were utilized to determine how people move about the space and interact with the items available. During the *American Art Deco* evaluation additional surveys and interviews were used to get a more robust picture of visitor's perceptions of the space. 162 visitor groups were observed using the *Weaving Splendor Creativity Studio*. In total, 145 visitor groups were observed using the *Art Deco Creativity Studio*, 100 visitor groups completed a survey of their experience, and 8 visitor groups participated in a semi-structured interview. 10 visit groups declined to take part in the visitor survey reducing the number from 110 to 100. Of the 10 visitors who chose not to participate 5 were in a rush, 4 did not provide a reason, and one felt that they did not do enough in the Creativity Studio to evaluate it.

# Report Structure

Due to the addition of surveys and interviews in the *Art Deco Creativity Studio* more of the charts and tables presented below will refer to this iteration of the project. Demographic and activity data referring to the *Art Deco Creativity Studio* include data from both interviews and surveys. Observation data of *Weaving Splendor* and *Art Deco* will be presented first, followed by *Art Deco* interview and survey data. 

# Creativity Studio Observations

Observations were designed to answer the following questions:

- Who is attending the *Creativity Studio*?
- How long do visitors spend in teh studio?
...
Add the same section as above for Art Deco

## Time Spent in Studio

Add a chart of both studios here

## What did visitors do in the studio?

Add in charts of activities and heat maps
